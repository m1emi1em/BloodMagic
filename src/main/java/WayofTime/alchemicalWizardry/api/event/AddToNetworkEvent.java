...
public class AddToNetworkEvent extends Event {
    ...
    /**
     * This event is called whenever the network is added to. If cancelled, no LP will be drained from the source. If
     * result is set to Result.DENY, the LP will still be drained but the soul network will not be added to.
     *
