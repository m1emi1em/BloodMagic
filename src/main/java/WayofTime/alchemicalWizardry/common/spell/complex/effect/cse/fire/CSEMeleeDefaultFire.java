...
public class CSEMeleeDefaultFire extends ComplexSpellEffect {
    ...
    public void modifyParadigm(SpellParadigm parad) {
        if (parad instanceof SpellParadigmMelee) {
            ((SpellParadigmMelee) parad)
                    .addEntityEffect(new MeleeDefaultFire(powerEnhancement, potencyEnhancement, costEnhancement));
        }
    }
    ...
    public int getCostOfEffect() {
        return (int) (25 * (1.2 * this.potencyEnhancement + 1)
                * (2.5 * this.powerEnhancement + 2)
