...
public class StorageBlockCraftingManager {
    ...
    public void addStorageBlockRecipes() {
        ...
        // }
        // }
        // else if((outputStack.stackSize == 1 && (recipe.getRecipeSize() == 9 || recipe.getRecipeSize() == 4)) ||
        // ((outputStack.stackSize == 9 || outputStack.stackSize == 4) && recipe.getRecipeSize() == 1))
        // {
        // tempRecipeList.add(recipe);
        // continue;
        // }
        ...
        // }
        //
        // if(isResultStackReversible(outputStack, 2, world, tempRecipeList) ||
        // isResultStackReversible(outputStack, 3, world, tempRecipeList))
        // {
        // tempRecipeList2.add(recipe);
        // AlchemicalWizardry.logger.info("Now adding recipe for " + outputStack + " to the compression
        // handler.");
        // }
        // }
        // }
