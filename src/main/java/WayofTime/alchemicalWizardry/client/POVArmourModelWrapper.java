...
public class POVArmourModelWrapper extends ModelRenderer {
    ...
    public POVArmourModelWrapper(ModelBase model) {
        ...
        resource = new ResourceLocation(((BoundArmour) ModItems.boundPlateFire)
                .getArmorTexture(plateStack, Minecraft.getMinecraft().thePlayer, 1, "POV"));
        addBox(
                0, 0, 0, 0, 0,
                0); // Adds in a blank box as it's required in certain cases such as rendering arrows in entities
    }
