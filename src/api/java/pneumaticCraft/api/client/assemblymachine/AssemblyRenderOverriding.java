...
public class AssemblyRenderOverriding {
    ...
    public static interface IAssemblyRenderOverriding {
         ...
         * here to rotate the model for example. push and pop matrices are not needed, this is done for you. You can
         * also choose to do the whole rendering yourself, you'll need to return false then to indicate that
        ...
        /**
         * Should return the distance the claw travels before it is gripped to the stack. By default it's 0.0875F for
         * items and 0.00625F for blocks, 0.09375 when the claw is completely closed.
         * 
         * @param renderedStack
         * @return
         */
