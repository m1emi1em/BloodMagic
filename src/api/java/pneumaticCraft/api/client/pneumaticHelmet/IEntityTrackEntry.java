...
/**
 * Implement this class and register it by adding it to the entityTrackEntries class. There needs to be a parameterless
 * constructor. For every entity that's applicable for this definition, an instance is created.
 */
