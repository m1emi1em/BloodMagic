...
public interface IPneumaticMachine {
    ...
    /**
     * In your TileEntity class which is implementing this interface you should keep a reference of an IAirHandler. You
     * can retrieve one by calling
     * {@link AirHandlerSupplier#getAirHandler(net.minecraft.tileentity.TileEntity, float, float, float, float)}. Do
     * this when your TileEntity is initialized, i.e. xCoord,yCoord,zCoord and worldObj have a value. In this method you
     * need to return this reference.
     *
     ...
     * to the IAirHandler. Apart from that you'll need to forward
