...
public interface IBlockAndCoordinatePollSensor {
     ...
     * coordinates as extra parameters. This method will only be called when the coordinate is within the Universal
     * Sensor's range.
     * 
     * @param world
     * @param x
     ...
     * @return
     */
    public int getRedstoneValue(World world, int x, int y, int z, int sensorRange, String textBoxText, int toolX,
            int toolY, int toolZ);
