...
public class SensorRegistrator {
    ...
    /**
     * This field will be initialized in the PreInit phase of PneumaticCraft's loading phase. With this field you can
     * register every Universal Sensor sensor you want. Just pass a new instance to one of the registerSensor methods.
     * Sensors are singletons.
     */
